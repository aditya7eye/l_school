    ...
    <div class="container-scroller">
        ...
        <nav class="navbar horizontal-layout col-lg-12 col-12 p-0">
            <div class="container d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-top">
                    <a class="navbar-brand brand-logo" href="{{ url('dashboard') }}"><img src="{{ url('images/logo-inverse.svg') }}" alt="logo"/></a>
                    <a class="navbar-brand brand-logo-mini" href="{{ url('dashboard') }}"><img src="{{ url('images/logo-mini.svg') }}" alt="logo"/></a>
                </div>
            ...
            <div class="nav-bottom">
                <div class="container">
                    <ul class="nav page-navigation">
                        <li class="nav-item">
                            <a href="{{ url('dashboard') }}" class="nav-link"><i class="link-icon mdi mdi-television"></i><span class="menu-title">DASHBOARD</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"><i class="link-icon mdi mdi-asterisk"></i><span class="menu-title">Settings</span><i class="menu-arrow"></i></a>
                            <div class="submenu">
                                <ul class="submenu-item">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('manage-admin') }}">Manage Admin</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ url('manage-plan') }}">Manage Plan</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <footer class="footer">
            <div class="container-fluid clearfix">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2018 <a href="http://7eyeitsolutions.com/" target="_blank">7eyeitsolutions</a>. All rights reserved.</span>
