            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                    <div class="card text-center">
                        <div class="card-body">
                            <img src="{{ url('images/faces/face5.jpg') }}" class="img-lg rounded-circle mb-2" alt="profile image" />
                            <h4>Maria Johnson</h4>
                ...
                <div class="col-12 grid-margin">
                            ...
                            <div class="fluid-container">
                                <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                                    ...
                                    <div class="ticket-details col-md-9">
                                        ...
                                        <p class="text-small text-gray mb-2">Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia
                    ...
                    Manage
                                ...
                                <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                                    ...
                                    <div class="ticket-details col-md-9">
                                        ...
                                        <p class="text-small text-gray mb-2">Pellentesque in ipsum id orci porta dapibus. Sed porttitor lectus nibh. Curabitur
                    ...
                    Manage
                                ...
                                <div class="row ticket-card mt-3">
                                    <div class="col-md-1">
                                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="{{ url('images/faces/face3.jpg') }}" alt="profile image">
                                    </div>
                                    <div class="ticket-details col-md-9">
                                        <div class="d-flex">
                                        ...
                                        <p class="text-small text-gray mb-2">Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Lorem
